...
<div className={Styles.background}>
      <div className="pt-16 px-6 md:pt-28 md:px-20 lg:mt-44 lg:ml-32">
        <h1 className="text-white font-extrabold text-3xl md:text-4xl lg:text-5xl mb-6">LegitDoc<sup>®</sup></h1>

        <div className="text-white font-semibold text-xl md:text-2xl mb-5">
          <p>A revolutionary platform</p>
          <p>for tamper-proof digital</p>
          <p>credential management</p>
        </div>
        
        <div className="text-white font-light text-lg md:text-xl mb-3">
          <p>LegitDoc is a scalable, API-first platform for enterprises and</p>
          <p>governments to issue and verify tamper-proof credentials on</p>  
          <p>blockchain.</p> 
        </div>
        
        <p className="text-white font-light text-sm md:text-base mb-2">Built on: Ethereum polygon</p>
        <a className="text-green-500 underline font-semibold text-lg md:text-xl" href="#">Talk To OUR EXPERT</a>
      </div>
    </div>
